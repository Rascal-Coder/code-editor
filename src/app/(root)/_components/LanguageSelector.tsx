...
function LanguageSelector() {
  ...
  const iconName = LANGUAGE_ICONS[language] || "vscode-icons:file-type-default";
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        opacity-0 group-hover:opacity-100 transition-opacity"
                        />
                        <Icon icon={LANGUAGE_ICONS[lang.id] || "vscode-icons:file-type-default"} className="w-full h-full" />
                      </div>
