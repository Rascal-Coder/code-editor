...
export const LANGUAGE_CONFIG: LanguageConfig = {
  javascript: {
    id: "javascript",
    label: "JavaScript",
    pistonRuntime: { language: "javascript", version: "18" },
...
console.log('Sum of numbers:', sum);`,
  ...
  typescript: {
    id: "typescript",
    label: "TypeScript",
    pistonRuntime: { language: "typescript", version: "" },
...
console.log('Sum of numbers:', math.sum());`,
  ...
  python: {
    id: "python",
    label: "Python",
    pistonRuntime: { language: "python", version: "3" },
...
print(f"Sum of numbers: {numbers_sum}")`,
  ...
  java: {
    id: "java",
    label: "Java",
    pistonRuntime: { language: "java", version: "17" },
    monacoLanguage: "java",
    defaultCode: `class Code {
  ...
  go: {
    id: "go",
    label: "Go",
    pistonRuntime: { language: "go", version: "1" },
    monacoLanguage: "go",
...
func main() {
  ...
  rust: {
    id: "rust",
    label: "Rust",
    pistonRuntime: { language: "rust", version: "1" },
    monacoLanguage: "rust",
    defaultCode: `fn main() {
    // Create vector
  ...
  cpp: {
    id: "cpp",
    label: "C++",
    pistonRuntime: { language: "cpp", version: "14" },
    monacoLanguage: "cpp",
...
int main() {
  ...
  c: {
    id: "c",
    label: "C",
    pistonRuntime: { language: "c", version: "11" },
    monacoLanguage: "c",
